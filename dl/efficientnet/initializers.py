...
class EfficientConv2DKernelInitializer(tf.initializers.Initializer):
    ...
    def __call__(self, shape, dtype=tf.keras.backend.floatx(), **kwargs):
...
class EfficientDenseKernelInitializer(tf.initializers.Initializer):
