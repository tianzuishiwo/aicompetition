...
# 所有参数配置
OFFLINE_SPLIT_DATA = 20000000000
ONLINE_SPLIT_DATA = 20000000000

USE_WHICH_DATA = SMALL_PATH  # small 文件下的小数据
# USE_WHICH_DATA = MEDIAN_PATH  # median 文件下的小数据
# USE_WHICH_DATA = BIG_PATH    # big 文件下的数据
# USE_WHICH_DATA = SOURCE_PATH    # source 文件下的数据
